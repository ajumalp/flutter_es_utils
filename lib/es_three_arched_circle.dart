...
class Arc extends CustomPainter {
  ...
  static Widget draw({
    ...
    return SizedBox(
      width: size,
      height: size,
      child: CustomPaint(painter: Arc._(color, strokeWidth, startAngle, endAngle)),
    );
  }
...
class ESThreeArchedCircle extends StatefulWidget {
  final double size;
  const ESThreeArchedCircle({
    Key? key,
    required this.size,
  }) : super(key: key);

  @override
  State<ESThreeArchedCircle> createState() => _ESThreeArchedCircleState();
}

class _ESThreeArchedCircleState extends State<ESThreeArchedCircle> with SingleTickerProviderStateMixin {
